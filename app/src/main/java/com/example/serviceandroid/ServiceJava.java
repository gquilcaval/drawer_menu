...
/**
 * Created by Giancarlos Quilca on 11/10/2022.
 */
public class ServiceJava extends Service implements Handler.Callback {
    ...
    public void onCreate() {
        ...
        HandlerThread handlerThread = new HandlerThread("Classic Services", 1);
        handlerThread.start();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i("ServiceTester", "pid: " );
        Log.i("ServiceTester", "tid: ");
